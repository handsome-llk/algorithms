...
//        quickSort(numArr.clone(), answerArr);
    ...
    public static void quickSortRandom(int[] numArr, int[] answerArr) {
        TimeRecord record = new TimeRecord();
...
//        SortUtil.getInstance().sysArr(numArr, "quickSortRandom");
    ...
    public static void quickSort2(int[] numArr, int[] answerArr) {
        TimeRecord record = new TimeRecord();
...
//        SortUtil.getInstance().sysArr(numArr, "quickSort2");
    ...
    public static void quickSort(int[] numArr, int[] answerArr) {
        TimeRecord record = new TimeRecord();
...
//        SortUtil.getInstance().sysArr(numArr, "insertSort");
    ...
    public static void answerSort(int[] numArr) {
        TimeRecord record = new TimeRecord();
        Arrays.sort(numArr);
